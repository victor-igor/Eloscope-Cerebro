...
|------|--------|---------|-------|
| Victor Igor | Produto / Elo OS / IA | victor.igr10@gmail.com | Criação e gestão do Elo OS, reuniões com clientes, estratégia de produto e IA · ClickUp ID: 156603223 (workspace 90171169593) · WhatsApp confirmado via uazapi · track_time: true |
| Lucas | Comercial / Financeiro | lucas.ns63@gmail.com | Fechamento de vendas, prospecção, relacionamento com clientes, financeiro · ClickUp ID: 82167120 (workspace 90171169593) · track_time: true (ativado 22/05/2026 via /validar-sessao) |
...
|------|---------|-------------------|---------|
| Alex | Gestor de tráfego (independente) | Tráfego pago da Enertelles · ponte estratégica pro Telles · parceiro Eloscope | — |
...
|------|----------|--------|----------|
| Telles (Enertelles) | Energia solar, Catanduva + Atibaia · 500 clientes · 7-8 vendas/mês · quer 20 | Proposta v4 modular (Bloco A R$3.500 + Bloco B R$3.000 + blog R$487/mês) | Call Telles + Alex 30/04 |

---

## Notas relacionais

- **Matheus Campos** = ponte estratégica. Sócio da Campos Joia + sócio da Morgana Sales (clínica da esposa Dra. Morgana). Foi ele que abriu a porta da Eloscope na Morgana. Em 28/04/2026 forneceu 1 celular + 2 chips para o projeto Morgana Sales (uso da IA de ativação de base).
