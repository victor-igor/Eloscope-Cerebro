...
- **Melhor momento:** após a segunda ou terceira reunião mensal (Dia 60–90)
- **Condição:** cliente demonstrou resultado positivo e está satisfeito
- **Quem coleta:** Lucas (relacionamento comercial)
- **Formato:** conversa por WhatsApp ou call de 20 minutos
...
## Estrutura do case (para publicação)

```
ANTES
[Nome] é [cargo] na [empresa], uma [segmento] com [X vendedores].
O problema: [dor principal em 1–2 frases diretas].
...
[Métrica 2]: de X para Y
[Métrica 3]: R$ X a mais por mês / por cliente

"[Citação do cliente sobre o resultado]"
— [Nome], [Cargo], [Empresa]
```
...
| Formato | Onde usar | Quem produz |
|---------|----------|-------------|
| Post LinkedIn (carrossel) | LinkedIn do Victor/Lucas | Victor (conteúdo) |
| Vídeo depoimento (1–2 min) | Instagram + LinkedIn | Cliente grava, Lucas edita |
| Slide no deck de vendas | Pitch para novos leads | Victor |
| Trecho no WhatsApp de abordagem | Lucas usa na prospecção | Lucas |
...
- [ ] Enviar rascunho do case ao cliente
- [ ] Cliente aprova por escrito (mensagem no WhatsApp vale)
- [ ] Registrar aprovação na pasta do cliente

---

## Métricas para rastrear por cliente

> Coletar esses dados mês a mês para ter o case completo no Dia 90.

| Métrica | Mês 0 (antes) | Mês 1 | Mês 2 | Mês 3 |
|---------|--------------|-------|-------|-------|
| Taxa de conversão (%) | | | | |
| Leads contatados/mês | | | | |
| Tempo médio 1º contato | | | | |
| % leads com follow-up | | | | |
| Leads reativados da base | | | | |
| Receita mensal (R$) | | | | |
