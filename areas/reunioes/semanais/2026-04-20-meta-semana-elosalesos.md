...
fonte: fathom
fonte_id: 139286021
fonte_url: https://fathom.video/calls/641733790
tags: [reuniao, semanal, interno, planejamento, produto/elo-os]
status: processada
---

# Semanal — 2026-04-20 (Semana 16) — Meta Semana / EloSalesOS

> 2026-04-20 - 90 min - Lucas, Victor, Hugo

## Retrospectiva da semana

**Entregas:**
- Levantamento dos pontos do produto (sprint 18/04) — definicao do EloSalesOS
- Ajustes da Fra (sexta + sabado) — pendente apenas agendamento recorrente
- Proposta Enertelles preparada (Lucas) — aguardando envio
- Estrutura inicial dos planos: Starter (1-2 vendedores), Mid (3-6), Pro (6-10)

**O que travou:**
- Fathom nao gravou reunioes anteriores (extensao instalada mas auto-record nao ativava no Mac do Lucas)
- Skill `/cerebro` nao apareceu no setup do Lucas (problema com .cloud / instalacao das skills)
- Slides de venda existem mas precisam refino
- Faturamento Voltrax travado — Samuel respondeu mas time enrolado

**Aprendizados:**
- Decisao de NAO mais customizar por cliente — produto padrao com modelo de negocio fixo (servico com time comercial)
- Call unica (discovery + venda no mesmo dia) ao inves do funil de duas etapas anterior
- Construir tudo no setup e cobrar TCV (3 meses upfront) reduz risco de churn precoce
- Q1 (sem time comercial) sai do escopo — vai virar outro produto no futuro

## Metricas-chave

| Metrica | Valor | vs. semana anterior |
|---------|-------|---------------------|
| Leads potenciais mapeados | 46 | novo (varredura Drive) |
| Pendencias abertas | 8 (1 critica, 7 importantes) | — |
| Projetos ativos | 3 (2 ativos, 1 em construcao) | — |

## Planejamento proxima semana

**Top 3 prioridades:**
1. Definir e organizar materiais comerciais do EloSalesOS (Playbook, funil, copies, apresentacao, landpage)
2. Colocar Morgana e Gian para rodar (numeros aquecidos + reuniao onboarding)
3. Comecar prospeccao ativa nos 46 leads do quadrante (servico + time comercial)

**Por pessoa:**

**Lucas (Eloscope/COO):**
- Enviar proposta Enertelles + reavaliar se inclui outros servicos
- Marcar reuniao Maquilam para primeiros testes (22/04)
- Validar com Matheus retorno do Campos (dados produtos novos)
- Ajustar pitch do site da Enertelles ja como produto EloSalesOS
- Comecar conscientizacao de leads via canal proprio (base vai acabar rapido)

**Victor:**
- Refinar slides de venda (versao iOS / produto)
- Fechar template de contrato do EloSalesOS (pendencia critica)
- Cobrar Jean (esta enrolando)
- Cobrar Matheus Campos para passar dados dos produtos novos
- Drag/modulo Maquilam: ajuste pendente
- Ajustar funcionalidade de agendamento recorrente para Fra (principal Fra agora)
- Inserir funcao "estado de estabelecimento" no SuperRapp (modus imobiliarios)

**Hugo:**
- SDR Morgana: validar configuracao + adicionar 2 FAQs novos (harmonizacao intima, canetas emagrecedoras/tirzepatida)
- Configurar funcao chat util (botao para vincular chatbot automatico)
- Apoiar onboarding Morgana
- Acompanhar primeiros disparos de campanha quando numero comprar

## Decisoes

- **Produto: EloSalesOS (alias EloOS)** — sistema comercial padronizado para empresas de servico com time comercial. Entregaveis: Playbook, IA Copiloto, IA Assistida, dashboard, treinamento do time, acompanhamento mensal.
- **Pricing Starter: R$3.000 setup + R$1.500/mes, minimo 3 meses (TCV R$7.500 upfront).** Planos Mid (3-6 vendedores) e Pro (6-10) com valores maiores. Acima de 10 = customizado.
- **TCV upfront** (3 meses pagos antecipados) — risco de churn precoce se cobrar mensal. Pode parcelar em 12x com juros.
- **Call unica** = discovery + analise estrategica + proposta no fim. Sem call de venda separada.
- **ICP estrito:** empresas de servico COM time comercial (>=2 vendedores). Faturamento minimo ~R$80k/mes. Q1 (sem time) sai do escopo — vira outro produto depois.
- **Escopo do produto NAO inclui:** agente de atendimento ao cliente, integracao com sistema fora do comercial, criacao de site/LP, licencas de ferramenta. Tudo isso = outra proposta.
- **Gate contratual:** cliente assina que mantera time comercial minimo de X (ex: 1 pessoa 20h/semana dedicada) — senao escala em causa, nao em processo.
- **Feedback ao vendedor via WhatsApp + dashboard** (CRM proprio Eloscope ou conexao com CRM do cliente).
- **Q1 (cliente sem time)** abandonado deste produto — Daniel/Voltrax tipo de cliente que NAO encaixa.
- **Open Cloud / paperclip / Hyperclick:** estudar mas seguir caminho conhecido (OpenFlow + Eleito ele) para nao travar venda.
- **Metas comerciais bonus:** considerar % sobre faturamento NOVO gerado (~0,2-0,4%) como modelo complementar — desenhar depois, complexo agora.

## Action Items

| # | Acao | Responsavel | Prazo |
|---|------|-------------|-------|
| 1 | Refinar slides de venda EloSalesOS | Victor | 24/04 |
| 2 | Fechar template de contrato EloSalesOS | Victor + Lucas | 24/04 |
| 3 | Enviar proposta Enertelles (+ avaliar outros servicos) | Lucas | 21/04 |
| 4 | Reuniao Maquilam — primeiros testes | Lucas | 22/04 |
| 5 | Finalizar SDR Morgana (2 FAQs + ajustes) | Hugo | 22/04 |
| 6 | Configurar funcao chat util (vinculo chatbot) | Hugo | 24/04 |
| 7 | Comprar 2 numeros (Morgana + Gian) e aquecer | Victor/Lucas | 24/04 |
| 8 | Cobrar Jean (atraso) | Victor | 22/04 |
| 9 | Cobrar Matheus Campos — dados produtos novos | Victor | 22/04 |
| 10 | Drag/modulo agente Maquilam — ajuste | Victor | 24/04 |
| 11 | Ajustar agendamento recorrente para Fra | Victor | 24/04 |
| 12 | Inserir funcao estado SuperRapp / modus imobiliarios | Victor | 24/04 |
| 13 | Organizar processo + materiais (comercial/marketing/operacional) EloOS | Victor + Lucas | 24/04 |
| 14 | Comecar pipeline EloOS dentro do sistema Eloscope | Lucas | 24/04 |
| 15 | Apresentacao de vendas + landpage + funil + copies | Victor | 24/04 |
| 16 | Comecar conteudo Instagram pessoal (marketing) | Lucas | continuo |
| 17 | Listar/qualificar 46 leads do quadrante servico+time | Lucas | 22/04 |
| 18 | Reuniao onboarding Morgana (chat util + sistema novo) | Lucas + Hugo | 24/04 |
| 19 | Setup skill /cerebro no ambiente do Lucas (debug instalacao) | Victor + Lucas | 21/04 |
