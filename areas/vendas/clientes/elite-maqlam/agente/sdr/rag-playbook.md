...
# Complementa rag-base.md | Chunks 14–20
...
Se cliente sumir no meio: aguardar 24h e enviar re-engajamento (ver Chunk 20).
...
## CHUNK 19 — Afiação de tesouras e lâminas

→ Ver Chunk 27 (scripts completos com valores reais e opção de envio pelos Correios).
...
- Prazo de entrega: [A PREENCHER]
- Formas de pagamento e parcelamento: [A PREENCHER]
- Frete grátis a partir de: [A PREENCHER]
- Marcas e diferenciais: [A PREENCHER]
...
## CHUNK 27 — Afiação (atualizado com scripts reais)
...
## CHUNK 32 — Explicação técnica com recomendação direta (P2)
...
## CHUNK 33 — Rastreio e status do pedido (S03/S04)
...
## CHUNK 35 — Trocas e reclamações (S12)
...
## CHUNK 36 — CNPJ e preço pessoa jurídica (S16)
