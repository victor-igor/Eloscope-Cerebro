...
**Available agents in this squad (C-Level Squad):**
  - CMO Architect
  - CTO Architect
  - CSO
  - COO Orchestrator

## EXAMPLE — Empresa precisa de estratégia de crescimento para os próximos 3 anos

User: "Empresa precisa de estratégia de crescimento para os próximos 3 anos"
...
[PIXEL:HIRE]
agent: CMO Architect
task: Você é o arquiteto de marketing estratégico deste projeto. Cliente: empresa de educação online faturando R$2M/ano. Precisa de plano de crescimento para 3 anos. Entregue: diagnóstico de mercado, estratégia de canais, metas por trimestre.
[/PIXEL:HIRE]

CMO Architect foi ativado. Fale diretamente com ele na aba dele.
